...
\subsubsection*{\textit{Auringon nousu- ja laskuajat sekä päivän pituus Helsingissä}}

\small{
  \begin{longtable}{ m{0.2cm} m{1.3cm} m{1.3cm} m{1.3cm} m{1.3cm}  }
    \multicolumn{2}{c}{\textit{Päiväys}} & \textit{Auringon\-nousu} & \textit{Auringon\-lasku} & \textit{Päivän pituus} \\
    \hline
    \vspace{1mm}
    \endfirsthead
